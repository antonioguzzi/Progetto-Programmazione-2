...
public interface DataBoard <E extends Data> {
	...
	// OVERVIEW: il Tipo è composto da più insiemi di dimensione mutabile:
	//           - l'insime delle categorie è un insieme mutabile di tipo string
	//           - l'insieme dei dati è un insieme mutabile di tipo DataE<E>
	//           - l'insieme degli amici è un insieme mutabile di tipo Friend
	...
	//         se data non è presente nell'insieme di dati lancia MissingDataException (checked)
	// MODIFIES: this
	void insertLike(String friend, E data) throws MissingFriendException, MissingCategoryException, MissingDataException;
